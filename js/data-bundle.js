...
const VAULTS_DATA = [
  ...
  { name: "Gold Vault", rarity: "UNCOMMON", rarityPercent: "1 in 6.00 [calculated]", priceMin: 10000, priceMax: 20000 },
  { name: "Sapphire Vault", rarity: "EPIC", rarityPercent: "1 in 47.46 [calculated]", priceMin: 30000, priceMax: 40000 },
  { name: "Ruby Vault", rarity: "MYTHIC", rarityPercent: "1 in 230.50 [calculated]", priceMin: 60000, priceMax: 70000 },
  { name: "Emerald Vault", rarity: "LEGENDARY", rarityPercent: "1 in 403.38 [calculated]", priceMin: 100000, priceMax: 150000 },
  { name: "Amethyst Vault", rarity: "LEGENDARY", rarityPercent: "1 in 1613.50 [calculated]", priceMin: 250000, priceMax: 275000 },
...
const CONTRIBUTORS_STAFF = [
  ...
  { name: "Ray_Meow", title: "Wiki Staff" },
  { name: "Za_Orangemonke", title: "Wiki Staff" },
  { name: "Ely", title: "Wiki Staff" },
...
const EVENT_JULY_4TH_2026 = [
  {
    ...
    date: "July 2026",
    dateColor: "#ffffffff",
    dateOutline: "#ff0000ff",
    description: "The first annual 4th of July event in Wanted!",
    features: [
      "Limited Time Firework Show at Boardwalk",
      "Event Items: Firework, Sparkler, USA Flag and New Limited Furniture",
      "Exclusive Rewards: 2026 Firework Wrap"
    ],
    image: "july-4th-2026"
  }
];
...
const GUN_CRATE_AUG_A1 = [

  {
    id: "aug-a1-crate",
    name: "AUG A1 Crate",
    description: "One of the most common crates in the game. It is a crate that gives you a free AUG A1",
    gun: "AUG A1",
    cooldown: "3 Days",
    location: "Crystal Club & Resort - Balcony of the Crystal Club"
  },
...
const GUN_CRATE_M4A1 = [

  {
    ...
    description: "It is a crate that gives you a free M4A1 with a AGOC Sight, Horizontal Foregrip and Tactical Laser pre-attached",
    name: "M4A1 Crate",
    gun: "M4A1",
    cooldown: "5 Days",
    location: "Harris Airports baggage area, next to where the planes dock"
  },
...
const GUN_CRATE_RPG_7 = [

  {
    id: "rpg-7-crate",
    showMoreButton: false,
    description: "It is a crate that gives you a free RPG-7",
    name: "RPG-7 Crate",
    gun: "RPG-7",
    cooldown: "5 Days",
...
const GUN_CRATE_UMP_45 = [
  ...
  {
    id: "ump-45-crate",
    description: "It is a crate that gives you a free UMP 45 with a Holographic Sight and Tactical Laser pre-attached",
    name: "UMP 45 Crate",
    gun: "UMP 45",
    cooldown: "1 Day",
    location: "Inside the Oasis City Police Station next to Justin's Armory"
  },
...
const GUN_CRATE_UZI = [
  ...
  {
    id: "uzi-crate",
    description: "It is a crate that gives you a free Uzi with an Uzi Stock pre-attached",
    name: "Uzi Crate",
    gun: "Uzi",
    cooldown: "1 Day",
    location: "Outside Fort Emberreach's - Desert Area in a RV"
  },
...
const MISSIONS_BERT_AIR_SUPPORT = [

  {
    ...
    description: "There's a lot of reasons to have a bird in the air. From rapid response to search and rescue and everything in between, a helicopter just makes everything easier.",
    howToComplete: "Provide air support for 20 minutes in a helicopter",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["800 Police XP", "$30,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_ALL_POINTS_BULLETIN = [

  {
    ...
    title: "All Points Bulletin - Part 1",
    location: "Police Station – Talk to Bert",
    description: "These are the criminals on the Most Wanted list: they're the most dangerous of the bunch.\n\nIf you can manage to take them down, the reward is massive. Be careful though.",
    howToComplete: "Arrest 1 criminal with 5 stars and collect 10,000 of police bounty cash",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["900 Police XP", "$30,000"],
    tipsAndInfo: []
  }
...
const MISSIONS_BERT_BANG_AND_CLEAR = [

  {
    ...
    howToComplete: "Arrest 5 criminals disoriented by flashbangs",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["600 Police XP", "$20,000"],
    tipsAndInfo: []
  },

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "Every raid is a risk: that's why we have to use every tool at our disposal. We use these non-lethal munitions to keep ourselves safe. Every once in a while a stun grenade ends up in a crib and people complain. That's life though. The baby probably had it coming to them.",
    howToComplete: "Arrest 15 criminals disoriented by flashbangs",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["1,000 Police XP", "$60,000"],
    tipsAndInfo: []
  }
];
...
const MISSIONS_BERT_BULLETPROOF = [

  {
    ...
    title: "Bulletproof",
    location: "Police Station – Talk to Bert",
    description: "The real weight of your armor doesn't come from the gear and ceramic plates, it's about what it does to your mind. It's a constant, physical reminder that you might be killed today. It warps your reality - and, pretty soon, everyone looks like an enemy, like a target. And that's how you look like to everyone else.",
    howToComplete: "Block 1000 bullets using shield",
    difficulty: "EASY",
    missionType: "Bert",
...
const MISSIONS_BERT_CALLING_ALL_UNITS = [
  {
    ...
    howToComplete: "Make a police crew with 5 Roblox friends and arrest 20 syndicates",
    difficulty: "HARD",
    missionType: "Bert",
    rewards: ["1,000 Police XP", "$50,000"],
    tipsAndInfo: []
  }
];
...
const MISSIONS_BERT_COMMUNITY_OUTREACH = [

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "A big part of the job is putting on a friendly face for the community. Being there for your neighbors. Go out there, knock on some doors, and shake some hands. Get to know the people you're fighting for.",
    howToComplete: "Patrol Suncrest Hills and Oakwood Estate for 5 minutes",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["150 Police XP", "$3,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_CON_AIR = [

  {
    ...
    title: "Con Air",
    location: "Police Station – Talk to Bert",
    description: "We need you down at the airport ASAP: there's been a hi-jacking. A crew snuck into the cargo plane as it was refueling and took the controls.\n\nMake your way on before takeoff and thwart the robbery before they get away with the plane and everything in it.",
    howToComplete: "Patrol Cargo Plane for 30 minutes, arrest 10 criminals at Cargo Plane and collect 30,000 of police bounty cash",
    difficulty: "HARD",
    missionType: "Bert",
    rewards: ["1,100 Police XP", "$60,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_COP_KILLER = [

  {
    ...
    title: "Cop Killer",
    location: "Police Station – Talk to Bert",
    description: "Cops aren't exactly popular. You never know who has it out for you. If you're not looking over your shoulder, one day someone will walk right up and shoot you in the back.",
    howToComplete: "Arrest 5 criminals for assaulting an officer",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["400 Police XP", "$7,500"],
    tipsAndInfo: []
...
const MISSIONS_BERT_COUNTER_INTEL = [

  {
    ...
    title: "Counter-Intel",
    location: "Police Station – Talk to Bert",
    description: "Ofy is an agent of a much larger criminal organization: known as the Syndicate. We need to learn more, it's time for you to go undercover. Infiltrate the Syndicate hideout and make a copy any useful information you find.",
    howToComplete: "Locate the Criminal Hideout at the Badlands and seize the Syndicate Intel.",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["150 Police XP", "$3,000"],
    tipsAndInfo: []
...
const MISSIONS_BERT_DIRTY_MONEY = [
  ...
  {
    id: "dirty-money-1",
    title: "Dirty Money - Part 1",
    location: "Police Station – Talk to Bert",
    description: "The intel you gathered suggests that Buck Moneymaker has ties to the Syndicate. He owns two banks: one downtown and one smaller bank in the Badlands. Raid them both.",
    howToComplete: "Raid both Downtown Bank and Badlands Bank for their files",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["500 Police XP", "$5,000"],
    tipsAndInfo: []
  },
  {
    id: "dirty-money-2",
    title: "Dirty Money - Part 2",
    location: "Police Station – Talk to Bert",
    description: "A lot of money moves through this city - and not all of it is legitimate. Seize the inventory manifests for the Jewelry Store and the City Port. Let's see what they're hiding.",
    howToComplete: "Seize the inventory manifests for the Jewelry Store and the City Port",
    difficulty: "EASY",
    missionType: "Bert",
...
const MISSIONS_BERT_FIRST_RESPONDER = [
...

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "Sometimes you're gonna be first on the scene. You won't have time to wait - you'll just have to act. People will need you to step up. Their lives will be in your hands.",
    howToComplete: "Revive 10 people",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["500 Police XP", "$5,000"],
    tipsAndInfo: []
...

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "Sometimes you're gonna be first on the scene. You won't have time to wait - you'll just have to act. People will need you to step up. Their lives will be in your hands.",
    howToComplete: "Revive 15 people",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["800 Police XP", "$10,000"],
    tipsAndInfo: []
  },
];
...
const MISSIONS_BERT_HOT_PURSUIT = [

  {
    ...
    title: "Hot Pursuit",
    location: "Police Station – Talk to Bert",
    description: "If you want to be effective in a high speed chase, you're going to have to master the pit maneuver. Position yourself behind their vehicle and slam their rear: they'll go spinning.",
    howToComplete: "Perform 3 successful PIT maneuvers",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["150 Police XP", "$3,000"],
    tipsAndInfo: []
...
const MISSIONS_BERT_INTRODUCTION = [

  {
    ...
    title: "Introduction - Bert",
    location: "Police Station – Talk to Bert",
    description: "Bert is the Captain of the Oasis City Police. Word is he's been looking for you specifically. Go meet him up at the Police Station and see what he wants. If it was that bad, you'd be in cuffs already.",
    howToComplete: "Go to the Police Station and talk to Bert",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["150 Police XP", "$10,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_LOSS_PREVENTION = [

  {
    ...
    howToComplete: "Arrest 5 criminals at Pear Store and confiscate 3 PearTech items",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["500 Police XP", "$5,000"],
    tipsAndInfo: []
...

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "We got a tip that a crew is going to hit the Pear Store. Go stake it out and roll in when they least expect it.",
    howToComplete: "PAtrol Pear Store for 15 minutes and confiscate 10 Gold PearTech items",
    difficulty: "MEDIUM",
    missionType: "Bert",
    rewards: ["700 Police XP", "$10,000"],
    tipsAndInfo: []
  }
];
...
const MISSIONS_BERT_NIGHT_SHIFT = [

  {
    ...
    title: "Night Shift",
    location: "Police Station – Talk to Bert",
    description: "Night-time is when all the real dangerous types come out. You're going to have to keep your wits about you. Go take a look around downtown at night and you'll see what I mean.",
    howToComplete: "Patrol Downtown at night for 30 minutes and arrest 10 Syndicates at night",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["900 Police XP", "$50,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_OFFICER_DOWN = [
  ...
  {
    id: "officer-down",
    title: "Officer Down - Part 1",
    location: "Police Station – Talk to Bert",
    description: "Fight or flight. That's when your stomach overrides your brain - and forces you to act. No matter how bad it looks, no matter how afraid you get: never leave your brothers and sisters behind. That's our code.",
    howToComplete: "Revive 10 officers under fire",
    difficulty: "MEDIUM",
    missionType: "Bert",
...
const MISSIONS_BERT_ON_PATROL = [

  {
    ...
    howToComplete: "Play with your crew for 20 minutes and patrol Jewelry Store for 10 minutes",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["600 Police XP", "$15,000"],
    tipsAndInfo: []
...

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "You're only as effective as the man sitting next to you. Surround yourself with the best and you will become the best. Build a crew of people that have your back, soldiers you trust. Then you'll be invincible.",
    howToComplete: "Play with your crew for 1 hour total, patrol Bank for 20 minutes total and arrest 3 criminals at Bank",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["900 Police XP", "$15,000"],
    tipsAndInfo: []
  },

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "You're only as effective as the man sitting next to you. Surround yourself with the best and you will become the best. Build a crew of people that have your back, soldiers you trust. Then you'll be invincible.",
    howToComplete: "Play with your crew for 4 hour total, patrol Downtown for 30 minutes total and arrest 10 criminals at Downtown",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["1,100 Police XP", "$40,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_POLICE_SHARPSHOOTER = [
  {
    ...
    location: "Police Station – Talk to Bert",
    description: "It's time to prove your marksmanship. Take out targets from over 100m away using a high-powered rifle. You know what Whitman and Oswald had in common? They were both marine snipers, trained right here in the U.S. of A. With a little training, you'll be able to do the same thing.",
    howToComplete: "Take down 10 criminals from over 100m away",
    difficulty: "HARD",
    missionType: "Bert",
    rewards: ["1,100 Police XP", "$60,000"],
    tipsAndInfo: []
...
const MISSIONS_BERT_PUBLIC_RELATIONS = [

  {
    ...
    howToComplete: "Patrol for 30 minutes in a Contender",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["250 Police XP", "$5,000"],
    tipsAndInfo: []
  },

  {
    id: "public-relations-2",
  ...
  {
    id: "public-relations-4",
    title: "Public Relations - Part 4",
    location: "Police Station – Talk to Bert",
    description: "It's time to trade in that boring cruiser of yours for something more exciting. Our image, as a department, is important. What else are we going to do with all that tax money?",
    howToComplete: "Patrol for 30 minutes in a Zorvello",
    difficulty: "MEDIUM",
    missionType: "Bert",
    rewards: ["900 Police XP", "$30,000"],
    tipsAndInfo: []
...
const MISSIONS_BERT_SEARCH_AND_SEIZURE = [

  {
    ...
    title: "Search & Seizure - Part 1",
    location: "Police Station – Talk to Bert",
    description: "These scumbags are just running around with bags of stolen gear - as if we don't have eyes. Go out there and shake them down. If they ask you for a warrant, just give me a call.",
    howToComplete: "Confiscate $2,000 worth of stolen goods",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["800 Police XP", "$5,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_SMASH_AND_GRAB = [
  ...
  {
    id: "smash-and-grab",
    title: "Smash & Grab - Part 1",
    location: "Police Station – Talk to Bert",
    description: "Suit up: we received another call. Jewelry heist in progress. Armed suspects. Bring them back in cuffs, and don't forget the jewelry either.",
    howToComplete: "Patrol Jewelry Store for 20 minutes and confiscate 10 jewelry items",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["400 Police XP", "$5,000"],
    tipsAndInfo: []
  },
...
const MISSIONS_BERT_STOLEN_GOODS = [

  {
    ...
    title: "Stolen Goods",
    location: "Police Station – Talk to Bert",
    description: "We received a tip about a shady pawn shop peddling stolen goods. I've had my eyes on this spineless crook for a while. Go down there and sweat him.",
    howToComplete: "Interrogate Ofy as Police and seize the stolen goods.",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["150 Police XP", "$3,000"],
    tipsAndInfo: []
...
const MISSIONS_BERT_TACTICAL_UNIT = [

  {
    ...
    title: "Tactical Unit",
    location: "Police Station – Talk to Bert",
    description: "It's time to familiarize yourself with special weapons and tactics, S.W.A.T.\n\nHostage rescue. High-risk warrants and standoffs. Counter-terrorism. These all require specialized tools, and a unique approach.",
    howToComplete: "Take down 10 criminals using P90",
    difficulty: "EASY",
    missionType: "Bert",
    rewards: ["900 Police XP", "$50,000"],
    tipsAndInfo: []
...
const MISSIONS_BERT_THE_ITALIAN_JOB = [

  {
    ...
    location: "Police Station – Talk to Bert",
    description: "We got a call of a heist happening downtown at the central bank. Gold is their target - don't let them get away.",
    howToComplete: "Patrol Bank for 30 minutes, arrest 10 criminals and confiscate 5 Gold bars",
    difficulty: "MEDIUM",
    missionType: "Bert",
    rewards: ["600 Police XP", "$20,000"],
    tipsAndInfo: []
...
const STORE_OTHER = [
  ...
  { name: "x200 Tier 1 Vehicle Crate", robuxPrice: 3149, description: "Gives 200 Tier 1 Vehicle Crates" },
  { name: "x10 Tier 2 Vehicle Crate", robuxPrice: 849, description: "Gives 10 Tier 2 Vehicle Crates" },
  { name: "x50 Tier 2 Vehicle Crate", robuxPrice: 3499, description: "Gives 50 Tier 2 Vehicle Crates" },
  { name: "x200 Tier 2 Vehicle Crate", robuxPrice: 10999, description: "Gives 200 Tier 2 Vehicle Crates" }
];
...
const VALUABLES_CHRISTMAS = [
  ...
  { name: "Red Ornament", description: "", rarity: "CHRISTMAS", price: 125, priceNonContract: false, weight: 1, commonLocation: "Small Presents" },
  { name: "Striped Ornament", description: "", rarity: "CHRISTMAS", price: 275, priceNonContract: false, weight: 1, commonLocation: "Small Presents" },
  { name: "Candy Cane", description: "", rarity: "CHRISTMAS", price: 777, priceNonContract: false, weight: 2, commonLocation: "Huge Presents" },
  { name: "Gold Ornament", description: "", rarity: "CHRISTMAS", price: 1000, priceNonContract: false, weight: 1, commonLocation: "Huge Presents" },
  { name: "Nutcracker", description: "", rarity: "CHRISTMAS", price: 1892, priceNonContract: false, weight: 3, commonLocation: "Huge Presents" },
  { name: "Snowglobe", description: "", rarity: "CHRISTMAS", price: 8888, priceNonContract: false, weight: 6, commonLocation: "Huge Presents" },
  { name: "White Ornament", description: "", rarity: "CHRISTMAS", price: 15000, priceNonContract: false, weight: 1, commonLocation: "Huge Presents" },
...
const VALUABLES_EASTER = [
  ...
  { name: "Soldier Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Tucked inside hackable crates at Fort Emberreach" },
  { name: "Waterfall Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Hidden behind the waterfall near Frostpire Mountain" },
  { name: "Secure Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "A rare find discovered within safes" },
  { name: "Void Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Recovered from the Anomaly at Frostpire Mountain" },
  { name: "Cargo Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Stashed inside shipping boxes at the Docks" },
  { name: "Golden Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Locked within the Oasis Bank vault" },
  { name: "Crypto Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Earned by successfully selling a Bitcoin" },
  { name: "Amethyst Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Locked within the Oasis Bank vault" },
  { name: "Parachute Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Recovering from falling Airdrop crates" },
  { name: "Carnival Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "At the top of the Ferris Wheel near the Jewelry Store" },
  { name: "Diamond Egg", description: "", rarity: "EASTER", category: "Easter", price: 8888, priceNonContract: false, weight: 1, commonLocation: "Secured within the Oasis City Jewelry Store" },
  { name: "Big Red Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 20, commonLocation: "Resting atop the bridge near the Police Station" },
  { name: "Prisoner Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Locked inside a jail cell at the Police Station" },
  { name: "Construction Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Perched on the construction crane near Oasis Bank" },
  { name: "Glass Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Displayed inside Ofys Value Pawn" },
  { name: "Syndicate Egg", description: "", rarity: "EASTER", category: "Easter", price: 0, priceNonContract: false, weight: 1, commonLocation: "Granted upon completing the Syndicegg Mission" },
...
const VALUABLES_ELECTRONICS = [
  ...
  { name: "HDD", description: "", rarity: "COMMON", category: "Electronics", price: 400, weight: 2, commonLocation: "Computers" },
  { name: "PearPhone", description: "", rarity: "COMMON", category: "Electronics", price: 400, weight: 2, commonLocation: "Pear Store" },
  { name: "GoldWatch", description: "", rarity: "UNCOMMON", category: "Electronics", price: 400, weight: 2, commonLocation: "Pear Store" },
  { name: "PearPad", description: "", rarity: "COMMON", category: "Electronics", price: 500, weight: 3, commonLocation: "Pear Store" },
  { name: "GoldPods", description: "", rarity: "UNCOMMON", category: "Electronics", price: 600, weight: 3, commonLocation: "Pear Store" },
  { name: "GoldPhone", description: "", rarity: "COMMON", category: "Electronics", price: 700, weight: 2, commonLocation: "Pear Store" },
  { name: "PSU", description: "", rarity: "COMMON", category: "Electronics", price: 800, weight: 6, commonLocation: "Computers" },
  { name: "GoldPad", description: "", rarity: "EPIC", category: "Electronics", price: 900, weight: 3, commonLocation: "Pear Store" },
  { name: "PearBook", description: "", rarity: "UNCOMMON", category: "Electronics", price: 1000, weight: 6, commonLocation: "Pear Store" },
  { name: "Flash Drive", description: "", rarity: "UNCOMMON", category: "Electronics", price: 1200, weight: 1, commonLocation: "Computers" },
  { name: "GoldBook", description: "", rarity: "EPIC", category: "Electronics", price: 1500, weight: 6, commonLocation: "Pear Store" },
  { name: "GPU", description: "", rarity: "EPIC", category: "Electronics", price: 9001, weight: 6, commonLocation: "Computers" },
...
const VALUABLES_GEMS = [
  ...
  { name: "Silver Bar", rarity: "COMMON", category: "Gems", price: 250, weight: 2, commonLocation: "Bank of Oasis",
    description: "" },
  { name: "Gold Bar", rarity: "UNCOMMON", category: "Gems", price: 400, weight: 2, commonLocation: "Bank of Oasis",
    description: "" },
  { name: "Sapphire", rarity: "EPIC", category: "Gems", price: 2500, weight: 4, commonLocation: "Bank of Oasis",
    description: "" },
  { name: "Ruby", rarity: "EPIC", category: "Gems", price: 10000, weight: 4, commonLocation: "Bank of Oasis",
    description: "" },
  { name: "Gold Brick", rarity: "EPIC", category: "Gems", price: 1400, weight: 3, commonLocation: "Cargo Plane",
    description: "" },
  { name: "Emerald", rarity: "LEGENDARY", category: "Gems", price: 25000, weight: 4, commonLocation: "Bank of Oasis",
    description: "" },
  { name: "Amethyst", rarity: "LEGENDARY", category: "Gems", price: 30000, weight: 4, commonLocation: "Bank of Oasis",
    description: "" },
  { name: "Diamond", rarity: "LEGENDARY", category: "Gems", price: 50000, weight: 4, commonLocation: "Oasis City Jewelry",
    description: "" },
...
const VALUABLES_JEWELRY = [
  ...
  { name: "Sapphire Ring", description: "", rarity: "UNCOMMON", category: "Jewelry", price: 300, weight: 1, commonLocation: "Oasis City Jewelry" },
  { name: "Silver Chain", description: "", rarity: "UNCOMMON", category: "Jewelry", price: 350, weight: 2, commonLocation: "Oasis City Jewelry" },
  { name: "Ruby Ring", description: "", rarity: "EPIC", category: "Jewelry", price: 500, weight: 1, commonLocation: "Oasis City Jewelry" },
  { name: "Gold Chain", description: "", rarity: "EPIC", category: "Jewelry", price: 800, weight: 2, commonLocation: "Oasis City Jewelry" },
  { name: "Emerald Ring", description: "", rarity: "EPIC", category: "Jewelry", price: 1500, weight: 2, commonLocation: "Oasis City Jewelry" },
  { name: "Pearl Necklace", description: "", rarity: "LEGENDARY", category: "Jewelry", price: 6666, weight: 2, commonLocation: "Oasis City Jewelry" },
  { name: "Amethyst Ring", description: "", rarity: "LEGENDARY", category: "Jewelry", price: 20000, weight: 1, commonLocation: "Oasis City Jewelry" },
  { name: "Diamond Ring", description: "", rarity: "LEGENDARY", category: "Jewelry", price: 8000, weight: 1, commonLocation: "Oasis City Jewelry" },
  { name: "Rollie", description: "", rarity: "LEGENDARY", category: "Jewelry", price: 50000, weight: 2, commonLocation: "Oasis City Jewelry" },
...
const VALUABLES_MISCELLANEOUS = [
  ...
  { name: "Secret Files", description: "", rarity: "EPIC", category: "Miscellaneous", price: 5000, weight: 2, commonLocation: "Fort Emberreach" },
  { name: "Bitcoin", description: "", rarity: "LEGENDARY", category: "Miscellaneous", price: 67000, weight: 1, commonLocation: "Computers" },
...
const VALUABLES_TECH = [
  ...
  { name: "CPU Fan", description: "", rarity: "COMMON", category: "Tech", price: 40, weight: 2, commonLocation: "Tech Shack Store" },
  { name: "Batteries", description: "", rarity: "COMMON", category: "Tech", price: 20, weight: 1, commonLocation: "Tech Shack Store" },
  { name: "Capacitors", description: "", rarity: "COMMON", category: "Tech", price: 30, weight: 1, commonLocation: "Tech Shack Store" },
  { name: "Wires", description: "", rarity: "COMMON", category: "Tech", price: 40, weight: 2, commonLocation: "Tech Shack Store" },
  { name: "RAM", description: "", rarity: "COMMON", category: "Tech", price: 100, weight: 1, commonLocation: "Tech Shack Store" },
...
const VEHICLE_ZORVELLO = [

  {
    name: "Zorvello",
    obtaining: "Bayview Motors",
    description: "The Zorvello is a very fast and agile sports car that is perfect for transportation and combat",
    type: "ground",
    repairPrice: 7500,
    repairPriceGarage: 2250,
...
const VEHICLE_WARDEN = [

  {
    ...
    stats: {
      ...
      acceleration: 31,
      braking: 53,
      Health: "Body-1,500/Wheels-500/Windows-700",
      armor: 6
    }
  },
...
const WEAPON_BALLISTIC_SHIELD = [
  {
    ...
    obtaining: "Police Level 2",
    location: "Police Armory",
    contractPrice: "Un-Buyable",
  }
];
...
const YOUTUBER_CREATOR_1 = {
  ...
  videos: [
    {
      title: "All Police Career Rewards! / Roblox Wanted / Part 28",
      thumbnail: "https://i.ytimg.com/vi/KZs4bPtYdvA/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAyo33Xsi16LH6EYo-asb0YS3AIgA",
      link: "https://www.youtube.com/watch?v=KZs4bPtYdvA"
    },
    {
      title: "Police Finally got Updated! / Roblox Wanted / Part 27",
      thumbnail: "https://i.ytimg.com/vi/IpAkMI57HAg/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAABItRkxqjpQBLvf3jDdEQ5HNyoQ",
      link: "https://www.youtube.com/watch?v=IpAkMI57HAg"
    },
    {
      title: "4th July Firework Show & USA Flag Loot! / Roblox Wanted / Part 26",
      thumbnail: "https://i.ytimg.com/vi/-SDf22J-z-o/hqdefault.jpg?sqp=-oaymwEnCNACELwBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLAC4LDyV2cQJy6PpWTxrpXelyDTLQ",
      link: "https://www.youtube.com/watch?v=-SDf22J-z-o"
    }
  ]
};
...
/* Sentinel: data bundle fully loaded */
window.__WANTED_DATA_BUNDLED = true;
